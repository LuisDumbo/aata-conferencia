...
return [
    ...
    [
        'slug'         => 'seguranca-responsiva',
        'initials'     => 'SR',
        'name'         => 'Avançando a Segurança e Mantendo os Requisitos Regulatórios: Implementação de Filosofias de Manutenção Responsiva.',
        'photo'        => 'assets/salas/seguranca-requisitos-regulatorios-implementacao-filosofias-manutencao-responsiva.png',
        'participants' => [
    ...
    [
        'slug'         => 'fatores-umanos-cns',
        'initials'     => 'FN',
        'name'         => 'Fatores Humanos na Gestão do Sistema CNS',
        'photo'        => 'assets/salas/fatores-humanos-gestao-sistema-cns.png',
        'participants' => [
            'Enia Kakombu – ZATSEA',
