                        ...
                        <div x-show="dropdownOpen" x-cloak x-transition @click.outside="dropdownOpen = false"
                            ...
                            <div class="bg-white rounded-xl shadow-lg border border-slate-100 py-2">
                                ...
                                <a href="{{ route('speakers') }}" @click="dropdownOpen = false"
                                    class="block px-4 py-2 text-sm {{ request()->routeIs('speakers') || request()->routeIs('speakers.show') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-700 hover:bg-slate-50 hover:text-indigo-700' }}">
                                    {{ t('nav.speakers') }}
                                </a>

                                <a href="{{ route('moderadores') }}" @click="dropdownOpen = false"
                                    class="block px-4 py-2 text-sm {{ request()->routeIs('moderadores') || request()->routeIs('moderadores.show') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-700 hover:bg-slate-50 hover:text-indigo-700' }}">
                                    {{ t('nav.moderadores') }}
                                </a>

                                <a href="{{ route('salas') }}" @click="dropdownOpen = false"
                                    class="block px-4 py-2 text-sm {{ request()->routeIs('salas') || request()->routeIs('salas.show') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-700 hover:bg-slate-50 hover:text-indigo-700' }}">
                                    {{ t('nav.salas') }}
                                </a>
                                ...
                                <a href="{{ route('biografia.avelino') }}" @click="dropdownOpen = false"
                                    class="block px-4 py-2 text-sm {{ request()->routeIs('biografia.avelino') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-700 hover:bg-slate-50 hover:text-indigo-700' }}">
                                    Biografia – Avelino Dias
                                </a>
                ...
                <div>
                    ...
                    <div x-show="mobileDropdownOpen" x-cloak class="mt-2 ml-4 flex flex-col gap-2 text-sm">
                        ...
                        <a @click="open=false; mobileDropdownOpen=false" href="{{ route('speakers') }}"
                            class="{{ request()->routeIs('speakers') || request()->routeIs('speakers.show') ? 'text-indigo-700' : 'text-slate-700 hover:text-indigo-700' }}">{{ t('nav.speakers') }}</a>
                        <a @click="open=false; mobileDropdownOpen=false" href="{{ route('moderadores') }}"
                            class="{{ request()->routeIs('moderadores') || request()->routeIs('moderadores.show') ? 'text-indigo-700' : 'text-slate-700 hover:text-indigo-700' }}">{{ t('nav.moderadores') }}</a>
                        <a @click="open=false; mobileDropdownOpen=false" href="{{ route('salas') }}"
                            class="{{ request()->routeIs('salas') || request()->routeIs('salas.show') ? 'text-indigo-700' : 'text-slate-700 hover:text-indigo-700' }}">{{ t('nav.salas') }}</a>
