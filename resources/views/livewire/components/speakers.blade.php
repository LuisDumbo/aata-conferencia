<section id="speakers" class="py-16 bg-slate-50">
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="text-center max-w-3xl mx-auto">
            <h2 class="text-3xl font-extrabold tracking-tight text-slate-900">{{ t('speakers.title') }}</h2>
        ...
        <div class="mt-10 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h3 class="text-xl font-extrabold text-slate-900">{{ t('speakers.see_all_title') }}</h3>
                    <p class="mt-2 text-sm text-slate-600">
                        {{ t('speakers.see_all_desc') }}
                    </p>
                </div>
