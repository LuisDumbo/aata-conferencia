...
use App\Livewire\Pages\SalasPage;
use App\Livewire\Pages\Salas\Show as SalasShow;
...
Route::get('/salas', SalasPage::class)->name('salas');
Route::get('/salas/{slug}', SalasShow::class)->name('salas.show');
